...
class PassengerRegistration():
    ...
    def getPassengerInfo(self):
        ...
        if self.dl == 1:
            ...
            self.departureLocation = "NOIDA"
        elif self.dl == 3:
            self.departureLocation = "GURGAON"
        elif self.dl == 4:
            self.departureLocation = "JAIPUR"
        else:
        ...
        if self.dpl == 1:
            self.destinationLocation = "AHEMDABAD"
        elif self.dpl == 2:
            self.destinationLocation = "GAZIABAD"
        elif self.dpl == 3:
            self.destinationLocation = "JODHPUR"
        elif self.dpl == 4:
            self.destinationLocation = "BHOPAL"
        # Enter destination Location Name END

        self.ddmmyyyy = input("Enter Date of Joiurney Like 07-07-2024   :")  #Date of Journey
