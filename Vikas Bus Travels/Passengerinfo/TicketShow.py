...
class TicketShow:
    ...
    def ticketShow(self):
        ...
        #print(bln)  
        print("------------------------------------------------------------------------------")
        print("                          Viaks Bus Travels                               ")
        print("------------------------------------------------------------------------------")
        print()
        print(" e_Ticket :", "Jaipur Address              : Railway Station Road, Sindhi Camp, Jaipur, Rajasthan, 302001")
        print("           ", "contact/Phone               : 8000800088,8888880000            ")
        print()
